        ...
        <div>
            ...
            <v-card class="mt-6 pl-10" max-width="600" flat>
                ...
                <v-card-actions class="ml-12">
                    <p class="green--text mr-4">
                        <i>active_account</i>
                    </p>
                    <v-btn class="btn_1" depressed>Deactivate</v-btn>
                </v-card-actions>
            </v-card>

            <!-- personal information in grid view -->
            <v-container v-for="detail in details" :key="detail.firstname">
                <div class="divider d-flex justify-space-between">
            ...
            <!-- emergency contact info -->
             <v-container v-for="item in emergency" :key="item.name">
                <div class="divider d-flex justify-space-between">
                    ...
                    <!-- They share the same dialog to edit -->
                    <v-btn depressed class="orange--text mb-1 edit" @click="dialog1 = true">Edit
                        <v-icon>mdi-pencil</v-icon>
                    </v-btn>
                </div>        
                        ...
                        <div class="personalForm d-flex justify-center">
                            ...
                            <div class="academicForm">
                                ...
                                <form>
                                    ...
                                    v-model="majored"
                                    :items="major"
                                    label="Current Major/Concentration"
                                    required
                                    ></v-select>
                                    ...
                                    v-model="minoring"
                                    :items="minor"
                                    label="Current Minor/Area of Study"
                                    required
                                    ></v-select>
                                    <v-btn dark depressed color="blue" class="mr-4 mt-10 submitted" @click="dialog3 = true">submit</v-btn>
                                </form> 
                            ...
                            <v-card flat class="ma-1"> 
                                <v-list-item three-line>
                                    <v-list-item-content>
                                        ...
                                        <v-list-item-title class="mb-1">{{ item.Enrollment_number }}</v-list-item-title>
                                    </v-list-item-content>
                                </v-list-item>
                            </v-card>
                        </v-row>
                            ...
                            <v-card flat class="ma-1"> 
                                <v-list-item three-line>
                                    <v-list-item-content>
                                        ...
                                        <v-list-item-title class="mb-1">{{ item.major }}</v-list-item-title>
                                    </v-list-item-content>
                                </v-list-item>
                            </v-card>
                        </v-row>
                            ...
                            <v-card flat class="ma-1"> 
                                <v-list-item three-line>
                                    <v-list-item-content>
                                        ...
                                        <v-list-item-title class="mb-1">{{ item.minor }}</v-list-item-title>
                                    </v-list-item-content>
                                </v-list-item>
                            </v-card>
                        </v-row>
            ...
            <v-btn color="orange" dark class="next display-1" to="/student_details2">next
...
export default {
    ...
    data: () => ({
        ...
        academic: [
            {
                Enrollment_number: '001AB',
                major: 'Lorem ipsum dolor, sit amet consectetur adipisicing',
                minor: 'Lorem ipsum dolor, sit amet consectetur'
            }
        ],
