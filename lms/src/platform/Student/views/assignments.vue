                    ...
                    <v-expansion-panel class="mt-4">
                        <v-expansion-panel-header class="blue lighten-4">
                            <template v-slot:default="{ open }">
                                <v-row no-gutters>
                                    <v-col cols="4" class="subtitle-1 ">Overdue Assignments</v-col>
                                </v-row>
                            </template>
  ...
  export default {
      components: {
       ...
       data: () => ({
        ...
        overdue: [
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 1', subtitle: 'Due Jan 9, 2014 18:59', link: '/student/assignment'},
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 2', subtitle: 'Due Jan 17, 2014 00:00', link: '/student/assignment'},
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 3', subtitle: 'Due Jan 28, 2014 12:59', link: '/student/assignment'},
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 4', subtitle: 'Due Jan 28, 2014 08:00', link: '/student/ssignment'}
        ],
        nodate: [
