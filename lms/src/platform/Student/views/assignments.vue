  ...
  export default {
      components: {
       ...
       data: () => ({
        ...
        overdue: [
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 1', subtitle: 'Due Jan 9, 2014 18:59', link: '/assignment'},
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 2', subtitle: 'Due Jan 17, 2014 00:00', link: '/assignment'},
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 3', subtitle: 'Due Jan 28, 2014 12:59', link: '/assignment'},
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 4', subtitle: 'Due Jan 28, 2014 08:00', link: '/ssignment'}
        ],
        nodate: [
