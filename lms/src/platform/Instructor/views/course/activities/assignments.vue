  ...
  export default {
      components: {
       ...
       data: () => ({
        ...
        overdue: [
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 1', subtitle: 'Due Jan 9, 2014 18:59', link: '/instructor/assignment'},
            { icon: 'mdi-file', iconClass: 'black', title: 'Assignment 2', subtitle: 'Due Jan 17, 2014 00:00', link: '/instructor/assignment'}
        ],
        nodate: [
