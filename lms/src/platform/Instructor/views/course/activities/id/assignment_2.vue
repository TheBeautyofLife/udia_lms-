    ...
    <div class="wrapper d-flex justify-lg-space-between">
        ...
        <div class="main_content">
            ...
            <div class="d-flex justify-lg-space-between mt-6">
                <h2 class="display-2 mb-3">Assignment 2</h2>
                <v-spacer></v-spacer>
                 <v-btn color="blue" class="font-weight-bold"  dark depressed>Mark sumitted Work</v-btn>
    ...
    data: () => ({
      ...
      HardBreak
        ...
        content: ` 
                  ...
                  2. What are these "great oppressions" preparing the world for? <strong>(p. 15)</strong> <br /><br />
